...
public class MenuNewFragment{
    public Table container, submenu;
    private Button currentMenu;
    private MenuRenderer renderer;
    public Seq<MenuButton> customButtons = new Seq<>();
    ...
    private void fadeInMenu(){
        ...
        //submenu.actions(Actions.translateBy(-100, 0), Actions.translateBy(100, 0, 1f, Interp.fade));
    }
    ...
    private void fadeOutMenu(){
        ...
        submenu.clearActions();
        submenu.actions(Actions.alpha(1f), Actions.alpha(0f, 0.5f, Interp.fade), Actions.run(() -> submenu.clearChildren()));
        //submenu.actions(Actions.translateBy(0, 0), Actions.translateBy(-100, 0, 1f, Interp.fade), Actions.run(() -> submenu.clearChildren()));
    }
