...
public class NewWallCrafter extends Block {
    static int idx = 0;
    ...
    public NewWallCrafter(String name){
        super(name);
    ...
    public void setBars(){
        ...
        addBar("drillspeed", (NewWallCrafterBuild e) ->
        ...
        if(liquidBoostIntensity != 1 && findConsumer(f -> f instanceof ConsumeLiquidBase && f.booster) instanceof ConsumeLiquidBase consBase){
            ...
            stats.add(Stat.booster,
                    StatValues.speedBoosters("{0}" + StatUnit.timesSpeed.localized(),
                            consBase.amount,
                            liquidBoostIntensity, false, liquid -> consBase instanceof ConsumeLiquid consumeLiquid && consumeLiquid.liquid == liquid)
            );
        }
    }
    ...
    public class NewWallCrafterBuild extends Building {
