...
public class ItemTurretV6 extends TurretV6{ //For backwards compatibility!
    ...
    public void setBars(){
        ...
        addBar("ammo", (ItemTurretBuildV6 entity) ->
                new Bar(
                        "stat.ammo",
                        Pal.ammo,
    ...
    public void init(){
        consume(new ConsumeItemFilter(i -> ammoTypes.containsKey(i)){
            ...
            public void build(Building build, Table table){
                ...
                content.items().each(i -> filter.get(i) && i.unlockedNow(),
                        item -> image.add(new ReqImage(new Image(item.uiIcon),
                                () -> build instanceof ItemTurretBuildV6 it && !it.ammo.isEmpty() && ((ItemEntry)it.ammo.peek()).item == item)));
            ...
            public float efficiency(Building build){
                ...
                return build instanceof ItemTurretBuildV6 it && !it.ammo.isEmpty() ? 1f : 0f;
            }
    ...
    public class ItemTurretBuildV6 extends TurretBuild{
