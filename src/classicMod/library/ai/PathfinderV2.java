...
import static classicMod.library.ai.PathfinderExtended.Ores;
import static classicMod.library.ai.PathfinderExtended.SteamVents;
import static mindustry.Vars.*;
import static mindustry.world.meta.BlockFlag.*;

public class PathfinderV2 implements Runnable {
    ...
    public static final int
            fieldCore = 0, fieldVent = 1, fieldOres = 2,
            maxFields = 10;
     ...
     */
    public static abstract class Flowfield extends Pathfinder.Flowfield {
