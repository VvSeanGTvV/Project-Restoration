package classicMod.library.graphics;
...
public class PixelatorV2 extends Pixelator implements Disposable{
    ...
    public void drawPixelate(){
        ...
        Core.camera.position.set((int)px + ((int)(camera.width) % 2 == 0 ? 0 : 0.25f), (int)py + ((int)(camera.height) % 2 == 0 ? 0 : 0.25f));
    ...
    public boolean enabled(){
        return Core.settings.getBool("pixelate-v2");
    }
